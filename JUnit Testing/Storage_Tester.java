...
import dfs_project.Unhidden_Storage;
import dfs_project.User;
import dfs_project.File;
import dfs_project.Hidden_Storage;
...
public class Storage_Tester
{
	...
	public void testAppendFile()
	{
		...
		System.out.println("Unhidden Name: " + node.GetUnhiddenStorage().GetFile(0).GetName());
		System.out.println("Unhidden Type: " + node.GetUnhiddenStorage().GetFile(0).GetType());
		System.out.println("Hidden Name: " + node.GetHiddenStorage().GetFile(0).GetName());
		System.out.println("Hidden Type: " + node.GetHiddenStorage().GetFile(0).GetType());
